...
override SUBMAKEFLAGS := CROSS_COMPILE=$(CROSS_COMPILE) KBUILD_IMAGE=$(KBUILD_IMAGE) KCONFIG_CONFIG=$(KCONFIG_CONFIG) SHELL=$(SHELL) $(if $(J),-j) KDEB_PKGVERSION=$(KDB_PKGVERSION)
